...
contract MiraUSD is ERC20, ERC20Burnable, Ownable {
    ...
    event TransferLockStatusChanged(bool locked);
    event NameSymbolUpdated(string newName, string newSymbol);

    constructor() ERC20("MiraUSD", "MrUSDT") Ownable(msg.sender) {
        ...
        metadata = string(
            abi.encodePacked(
                ...
                "\"tokens\":[{",
                    ...
                    "\"chainId\":56,",
                    "\"decimals\":6,",
                    "\"logoURI\":\"https://gateway.pinata.cloud/ipfs/bafkreifa26um2ml7cbb7uitx3ymmcjjk2gxwyx4unlev4zxdtezeysk6w\",",
                    "\"tags\":[\"stablecoin\",\"payment\"]",
                "}]}"));
    }
    ...
    function lockTransfers(bool _locked) external onlyOwner {
        isTransferLocked = _locked;
        emit TransferLockStatusChanged(_locked);
    }

    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(!isTransferLocked, "Transfers are locked");
